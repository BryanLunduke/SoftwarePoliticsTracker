...
| &nbsp; | Software | Notes |
| - | - | - |
| :arrow_left: | **Lunduke Journal** | Creator shows continued behaviour which is [against government surveillance/power and promoting a more open and accepting level of software freedom](https://github.com/BryanLunduke/DoesItAgeVerify), which would go against the goal of reducing or removing wokeness from the world. He also shows [behaviour suggesting a belief/acknowledgement that there may be injustice in society (him having to live with other viewpoints) that he must work to correct](https://github.com/BryanLunduke/SoftwarePoliticsTracker). Creator also is shown to believe in ENFORCED freedom through continued use of GPL licenses<sup>[\[1\]](https://github.com/BryanLunduke/Linux-Tycoon) [\[2\]](https://github.com/BryanLunduke/rms-support-letter.github.io) [\[3\]](https://github.com/BryanLunduke/LundukeHoliday) [\[4\]](https://github.com/BryanLunduke/SuperFramework) [\[5\]](https://github.com/BryanLunduke/Wikipedia-Donation-Destroyer)</sup>, which acknowledges that there is injustice when people steal software, and acknowledging injustice is woke. Creator also [put effort into supporting multiple religions in his holiday scripts](https://github.com/BryanLunduke/LundukeHoliday), and inclusivity is another common woke behaviour especially when it covers many differing creeds. Creator has also [chosen to consistently use](https://github.com/BryanLunduke) software created by a woke provider<sup>[\[1\]](https://github.com/BryanLunduke/SoftwarePoliticsTracker#:~:text=Apple) [\[2\]](https://github.com/BryanLunduke/SoftwarePoliticsTracker#:~:text=Microsoft)</sup>. |
| :arrow_left: | **Apple** | [Has created pride gear](https://www.apple.com/newsroom/2025/05/apple-introduces-the-2025-pride-collection/), [DEI Tracking](https://www.apple.com/diversity/), [Against DEI removal](https://www.foxbusiness.com/markets/apples-board-recommended-shareholders-reject-dei-rollback-proposal), [Has pregnancy emojies that are not women](https://www.foxbusiness.com/technology/pregnant-man-emoji-apple), [Woke ad](https://www.youtube.com/watch?v=qj1hylrwsT0) |
